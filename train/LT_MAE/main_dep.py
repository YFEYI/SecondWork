...
import torch
import warnings
from data.datautils import load_SEED_indep,load_SEED_dep
...
def main_dep():
    ...
    for i in range(15):
        ...
        #train_ratio在这里写死了，不受args控制
        Train_data_all, Test_data = load_SEED_dep(path=args.data_path, dataset=args.data_set,time_step=args.time_steps, subject=i,train_ratio = 0.5, seed=44, label_nums=4)
